...
-define(equals_naive_fuel(Input, Expected), ?_assertEqual(day1:fuel_required_naive(Input), Expected)).
-define(equals_compound_fuel(Input, Expected), ?_assertEqual(day1:fuel_required_compound(Input), Expected)).

part1_test_() ->
    [
     {"For a mass of 12, divide by 3 and round down to get 4,
      then subtract 2 to get 2.",
      ?equals_naive_fuel(12, 2)},

     {"For a mass of 14, dividing by 3 and rounding down still yields 4,
      so the fuel required is also 2.",
      ?equals_naive_fuel(14, 2)},

     {"For a mass of 1969, the fuel required is 654.",
      ?equals_naive_fuel(1969, 654)},

     {"For a mass of 100756, the fuel required is 33583.",
      ?equals_naive_fuel(100756, 33583)}
    ].
...
part2_test_() ->
    [
     ...
     {"At first, a module of mass 1969 requires 654 fuel.
        ...
        So, the total fuel required for a module of mass 1969
        is 654 + 216 + 70 + 21 + 5 = 966.",
      ?equals_compound_fuel(1969, 966)},

     {"The fuel required by a module of mass 100756
        and its fuel is: 33583 + 11192 + 3728 + 1240 + 411
        + 135 + 43 + 12 + 2 = 50346.",
      ?equals_compound_fuel(100756, 50346)}
    ].
