...
start_link(Role, Skill) ->
    gen_server:start_link({local, Role},
                          ?MODULE, [Role, Skill], []).
...
pick_name() ->
    lists:nth(random:uniform(6), firstnames()) ++ " " ++
    lists:nth(random:uniform(6), lastnames()).

firstnames() -> ["Ringo", "Paul", "John", "George", "Jimmy", "Ludwig"].
lastnames() -> ["Star", "McCartney", "Lennon", "Harrison", "Hendrix", "van Beethoven"].
